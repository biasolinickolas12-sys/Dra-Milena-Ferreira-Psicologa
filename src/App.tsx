    ...
    <section id="quiz" className="py-20 md:py-32 bg-transparent relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <div className="bg-gradient-to-br from-indigo-100 via-purple-100 to-violet-200 backdrop-blur-2xl rounded-[2.5rem] md:rounded-[3rem] p-6 md:p-20 relative overflow-hidden shadow-[0_50px_100px_-20px_rgba(99,102,241,0.35)] border border-violet-200 min-h-[550px] flex flex-col justify-center">
